...
```php
  'trusted_domains' => 
  array (
    0 => 'nextcloud.pce-cloud-1.test',
  ),
```

```php
  'overwrite.cli.url' => 'https://nextcloud.pce-cloud-1.test',
```

- Se connecter à [https://nextcloud.pce-cloud-1.test](https://nextcloud.pce-cloud-1.test) avec le compte `admin`/`admin`.
...
`https://collabora.pce-cloud-1.test`.

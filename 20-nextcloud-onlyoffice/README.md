...
- Dans le menu **Applications**, ajouter l'application **ONLYOFFICE** (Catégorie *Bureautique & texte*) (ou `occ app:install onlyoffice`)
...
- Installer le plugin External Storage sur tous les environnements. (`occ app:install files_external`)
